        ...
        .subcommand(
            SubCommand::with_name("env")
                ...
                .subcommand(SubCommand::with_name("sync")
                    ...
                    .arg(Arg::with_name("no_change").long("no_change").help("Set new vars with the current value silently"))
                    ...
                    .group(ArgGroup::with_name("update_action").args(&["empty","no_change"]).multiple(false))
